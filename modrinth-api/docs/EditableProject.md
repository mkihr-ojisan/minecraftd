...
**license_id** | Option<**String**> | The SPDX license ID of a project | [optional]
**license_url** | Option<**String**> | The URL to this license | [optional]
**moderation_message** | Option<**String**> | The title of the moderators' message for the project | [optional]
**moderation_message_body** | Option<**String**> | The body of the moderators' message for the project | [optional]
