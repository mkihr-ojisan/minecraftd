...
pub async fn category_list(configuration: &configuration::Configuration, ) -> Result<Vec<models::CategoryTag>, Error<CategoryListError>> {

    let uri_str = format!("{}/tag/category", configuration.base_path);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ...
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::CategoryTag&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::CategoryTag&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn donation_platform_list(configuration: &configuration::Configuration, ) -> Result<Vec<models::DonationPlatformTag>, Error<DonationPlatformListError>> {

    let uri_str = format!("{}/tag/donation_platform", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::DonationPlatformTag&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::DonationPlatformTag&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
#[deprecated]
pub async fn license_list(configuration: &configuration::Configuration, ) -> Result<Vec<models::LicenseTag>, Error<LicenseListError>> {

    let uri_str = format!("{}/tag/license", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::LicenseTag&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::LicenseTag&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn license_text(configuration: &configuration::Configuration, id: &str) -> Result<models::License, Error<LicenseTextError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/tag/license/{id}", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn loader_list(configuration: &configuration::Configuration, ) -> Result<Vec<models::LoaderTag>, Error<LoaderListError>> {

    let uri_str = format!("{}/tag/loader", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::LoaderTag&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::LoaderTag&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn project_type_list(configuration: &configuration::Configuration, ) -> Result<Vec<String>, Error<ProjectTypeListError>> {

    let uri_str = format!("{}/tag/project_type", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn report_type_list(configuration: &configuration::Configuration, ) -> Result<Vec<String>, Error<ReportTypeListError>> {

    let uri_str = format!("{}/tag/report_type", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn side_type_list(configuration: &configuration::Configuration, ) -> Result<Vec<String>, Error<SideTypeListError>> {

    let uri_str = format!("{}/tag/side_type", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn version_list(configuration: &configuration::Configuration, ) -> Result<Vec<models::GameVersionTag>, Error<VersionListError>> {

    let uri_str = format!("{}/tag/game_version", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;models::GameVersionTag&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;models::GameVersionTag&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
