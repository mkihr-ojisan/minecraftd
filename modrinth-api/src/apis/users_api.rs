...
pub async fn change_user_icon(configuration: &configuration::Configuration, id_pipe_username: &str, body: Option<std::path::PathBuf>) -> Result<(), Error<ChangeUserIconError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id_pipe_username = id_pipe_username;
    let p_body_body = body;

    let uri_str = format!("{}/user/{id_username}/icon", configuration.base_path, id_username=crate::apis::urlencode(p_path_id_pipe_username));
...
pub async fn delete_user_icon(configuration: &configuration::Configuration, id_pipe_username: &str) -> Result<(), Error<DeleteUserIconError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id_pipe_username = id_pipe_username;
...
pub async fn get_followed_projects(configuration: &configuration::Configuration, id_pipe_username: &str) -> Result<Vec<models::Project>, Error<GetFollowedProjectsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id_pipe_username = id_pipe_username;

    let uri_str = format!("{}/user/{id_username}/follows", configuration.base_path, id_username=crate::apis::urlencode(p_path_id_pipe_username));
...
pub async fn get_payout_history(configuration: &configuration::Configuration, id_pipe_username: &str) -> Result<models::UserPayoutHistory, Error<GetPayoutHistoryError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id_pipe_username = id_pipe_username;

    let uri_str = format!("{}/user/{id_username}/payouts", configuration.base_path, id_username=crate::apis::urlencode(p_path_id_pipe_username));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `models::UserPayoutHistory`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `models::UserPayoutHistory`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn get_user(configuration: &configuration::Configuration, id_pipe_username: &str) -> Result<models::User, Error<GetUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id_pipe_username = id_pipe_username;

    let uri_str = format!("{}/user/{id_username}", configuration.base_path, id_username=crate::apis::urlencode(p_path_id_pipe_username));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_user_from_auth(configuration: &configuration::Configuration, ) -> Result<models::User, Error<GetUserFromAuthError>> {
...
pub async fn get_user_projects(configuration: &configuration::Configuration, id_pipe_username: &str) -> Result<Vec<models::Project>, Error<GetUserProjectsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id_pipe_username = id_pipe_username;

    let uri_str = format!("{}/user/{id_username}/projects", configuration.base_path, id_username=crate::apis::urlencode(p_path_id_pipe_username));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_users(configuration: &configuration::Configuration, ids: &str) -> Result<Vec<models::User>, Error<GetUsersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn modify_user(configuration: &configuration::Configuration, id_pipe_username: &str, editable_user: Option<models::EditableUser>) -> Result<(), Error<ModifyUserError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id_pipe_username = id_pipe_username;
...
pub async fn withdraw_payout(configuration: &configuration::Configuration, id_pipe_username: &str, amount: i32) -> Result<(), Error<WithdrawPayoutError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id_pipe_username = id_pipe_username;
