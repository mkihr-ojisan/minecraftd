...
impl CreatableVersion {
    pub fn new(name: String, version_number: String, dependencies: Vec<models::VersionDependency>, game_versions: Vec<String>, version_type: VersionType, loaders: Vec<String>, featured: bool, project_id: String, file_parts: Vec<String>) -> CreatableVersion {
        CreatableVersion {
            name,
            version_number,
            changelog: None,
