...
impl Version {
    pub fn new(name: String, version_number: String, game_versions: Vec<String>, version_type: VersionType, loaders: Vec<String>, featured: bool, id: String, project_id: String, author_id: String, date_published: String, downloads: i32, files: Vec<models::VersionFile>) -> Version {
        Version {
            name,
            version_number,
            changelog: None,
