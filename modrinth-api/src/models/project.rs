...
pub struct Project {
    ...
    #[serde(rename = "additional_categories", skip_serializing_if = "Option::is_none")]
    pub additional_categories: Option<Vec<String>>,
    /// An optional link to where to submit bugs or issues with the project
    #[serde(rename = "issues_url", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "body_url", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub body_url: Option<Option<String>>,
    #[serde(rename = "moderator_message", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl Project {
    pub fn new(slug: String, title: String, description: String, categories: Vec<String>, client_side: ClientSide, server_side: ServerSide, body: String, status: Status, project_type: ProjectType, downloads: i32, id: String, team: String, published: String, updated: String, followers: i32) -> Project {
        Project {
            slug,
            title,
            description,
