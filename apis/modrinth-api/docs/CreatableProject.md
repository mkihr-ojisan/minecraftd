...
**license_url** | Option<**String**> | The URL to this license | [optional]
**project_type** | **ProjectType** |  (enum: mod, modpack) | 
**initial_versions** | Option<[**Vec<models::EditableVersion>**](EditableVersion.md)> | A list of initial versions to upload with the created project. Deprecated - please upload version files after initial upload. | [optional]
**is_draft** | Option<**bool**> | Whether the project should be saved as a draft instead of being sent to moderation for review. Deprecated - please always mark this as true. | [optional]
**gallery_items** | Option<[**Vec<models::CreatableProjectGalleryItem>**](CreatableProjectGalleryItem.md)> | Gallery images to be uploaded with the created project. Deprecated - please upload gallery images after initial upload. | [optional]
