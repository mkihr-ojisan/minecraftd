...
pub async fn delete_thread_message(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<DeleteThreadMessageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/message/{id}", configuration.base_path, id=crate::apis::urlencode(p_path_id));
...
pub async fn get_open_reports(configuration: &configuration::Configuration, count: Option<i32>) -> Result<Vec<models::Report>, Error<GetOpenReportsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_count = count;

    let uri_str = format!("{}/report", configuration.base_path);
...
pub async fn get_report(configuration: &configuration::Configuration, id: &str) -> Result<models::Report, Error<GetReportError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/report/{id}", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_reports(configuration: &configuration::Configuration, ids: &str) -> Result<Vec<models::Report>, Error<GetReportsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;

    let uri_str = format!("{}/reports", configuration.base_path);
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_thread(configuration: &configuration::Configuration, id: &str) -> Result<models::Thread, Error<GetThreadError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/thread/{id}", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn get_threads(configuration: &configuration::Configuration, ids: &str) -> Result<Vec<models::Thread>, Error<GetThreadsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn modify_report(configuration: &configuration::Configuration, id: &str, modify_report_request: Option<models::ModifyReportRequest>) -> Result<(), Error<ModifyReportError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn send_thread_message(configuration: &configuration::Configuration, id: &str, thread_message_body: Option<models::ThreadMessageBody>) -> Result<models::Thread, Error<SendThreadMessageError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn submit_report(configuration: &configuration::Configuration, creatable_report: Option<models::CreatableReport>) -> Result<models::Report, Error<SubmitReportError>> {
    // add a prefix to parameters to efficiently prevent name collisions
