...
pub async fn add_team_member(configuration: &configuration::Configuration, id: &str, user_identifier: Option<models::UserIdentifier>) -> Result<(), Error<AddTeamMemberError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_user_identifier = user_identifier;

    let uri_str = format!("{}/team/{id}/members", configuration.base_path, id=crate::apis::urlencode(p_path_id));
...
pub async fn delete_team_member(configuration: &configuration::Configuration, id: &str, id_pipe_username: &str) -> Result<(), Error<DeleteTeamMemberError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_path_id_pipe_username = id_pipe_username;

    let uri_str = format!("{}/team/{id}/members/{id_username}", configuration.base_path, id=crate::apis::urlencode(p_path_id), id_username=crate::apis::urlencode(p_path_id_pipe_username));
...
pub async fn get_project_team_members(configuration: &configuration::Configuration, id_pipe_slug: &str) -> Result<Vec<models::TeamMember>, Error<GetProjectTeamMembersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id_pipe_slug = id_pipe_slug;

    let uri_str = format!("{}/project/{id_slug}/members", configuration.base_path, id_slug=crate::apis::urlencode(p_path_id_pipe_slug));
...
pub async fn get_team_members(configuration: &configuration::Configuration, id: &str) -> Result<Vec<models::TeamMember>, Error<GetTeamMembersError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn get_teams(configuration: &configuration::Configuration, ids: &str) -> Result<Vec<Vec<models::TeamMember>>, Error<GetTeamsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
    ...
    if !status.is_client_error() && !status.is_server_error() {
        ...
        match content_type {
            ContentType::Json => serde_json::from_str(&content).map_err(Error::from),
            ContentType::Text => return Err(Error::from(serde_json::Error::custom("Received `text/plain` content type response that cannot be converted to `Vec&lt;Vec&lt;models::TeamMember&gt;&gt;`"))),
            ContentType::Unsupported(unknown_type) => return Err(Error::from(serde_json::Error::custom(format!("Received `{unknown_type}` content type response that cannot be converted to `Vec&lt;Vec&lt;models::TeamMember&gt;&gt;`")))),
        }
    } else {
        let content = resp.text().await?;
...
pub async fn join_team(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<JoinTeamError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;

    let uri_str = format!("{}/team/{id}/join", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::POST, &uri_str);
...
pub async fn modify_team_member(configuration: &configuration::Configuration, id: &str, id_pipe_username: &str, modify_team_member_body: Option<models::ModifyTeamMemberBody>) -> Result<(), Error<ModifyTeamMemberError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_path_id_pipe_username = id_pipe_username;
...
pub async fn transfer_team_ownership(configuration: &configuration::Configuration, id: &str, user_identifier: Option<models::UserIdentifier>) -> Result<(), Error<TransferTeamOwnershipError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
    let p_body_user_identifier = user_identifier;

    let uri_str = format!("{}/team/{id}/owner", configuration.base_path, id=crate::apis::urlencode(p_path_id));
    let mut req_builder = configuration.client.request(reqwest::Method::PATCH, &uri_str);
