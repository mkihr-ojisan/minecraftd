...
pub async fn delete_notification(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<DeleteNotificationError>> {
    ...
    let uri_str = format!("{}/notification/{id}", configuration.base_path, id=crate::apis::urlencode(p_path_id));
...
pub async fn delete_notifications(configuration: &configuration::Configuration, ids: &str) -> Result<(), Error<DeleteNotificationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_notification(configuration: &configuration::Configuration, id: &str) -> Result<models::Notification, Error<GetNotificationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn get_notifications(configuration: &configuration::Configuration, ids: &str) -> Result<Vec<models::Notification>, Error<GetNotificationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
...
pub async fn get_user_notifications(configuration: &configuration::Configuration, id_pipe_username: &str) -> Result<Vec<models::Notification>, Error<GetUserNotificationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id_pipe_username = id_pipe_username;

    let uri_str = format!("{}/user/{id_username}/notifications", configuration.base_path, id_username=crate::apis::urlencode(p_path_id_pipe_username));
    let mut req_builder = configuration.client.request(reqwest::Method::GET, &uri_str);
...
pub async fn read_notification(configuration: &configuration::Configuration, id: &str) -> Result<(), Error<ReadNotificationError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_path_id = id;
...
pub async fn read_notifications(configuration: &configuration::Configuration, ids: &str) -> Result<(), Error<ReadNotificationsError>> {
    // add a prefix to parameters to efficiently prevent name collisions
    let p_query_ids = ids;
