...
pub struct EditableProject {
    ...
    #[serde(rename = "moderation_message", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    pub moderation_message: Option<Option<String>>,
    /// The body of the moderators' message for the project
    #[serde(rename = "moderation_message_body", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
