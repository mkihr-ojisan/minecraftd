...
pub struct User {
    ...
    #[serde(rename = "payout_data", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "auth_providers", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "has_password", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "has_totp", default, with = "::serde_with::rust::double_option", skip_serializing_if = "Option::is_none")]
...
impl User {
    pub fn new(username: String, id: String, avatar_url: String, created: String, role: Role) -> User {
        User {
            username,
            name: None,
            email: None,
