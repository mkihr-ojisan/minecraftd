...
pub struct PatchProjectsBody {
    ...
    #[serde(rename = "add_additional_categories", skip_serializing_if = "Option::is_none")]
    pub add_additional_categories: Option<Vec<String>>,
    /// Remove all of the additional categories specified here
    #[serde(rename = "remove_additional_categories", skip_serializing_if = "Option::is_none")]
    ...
    #[serde(rename = "remove_donation_urls", skip_serializing_if = "Option::is_none")]
